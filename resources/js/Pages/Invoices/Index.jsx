...
export default function Index({
    ...
    const statItems = [
        ...
        { label: "30 days", key: "30 days", bgColor: "bg-base-100", borderColor: "border-teal-500" },
        { label: "31-60 days", key: "31-60 days", bgColor: "bg-base-100", borderColor: "border-cyan-500" },
        { label: "61-90 days", key: "61-90 days", bgColor: "bg-base-100", borderColor: "border-sky-500" },
        { label: "91 over", key: "91 over", bgColor: "bg-base-100", borderColor: "border-blue-600" },
        { label: "All Total", key: "All", bgColor: "bg-base-100", borderColor: "border-slate-600" },
    ]
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
                    {statItems.map(({ label, key, bgColor, borderColor }) => (
                        <div key={label} className={`${bgColor} rounded-lg p-4 border-l-4 ${borderColor} shadow-md`}>
                            ...
                            }).format(processingCounts[key].total_amount || 0)}</span>
                        </div>
                    ))}
                </div>
